// Modèle de configuration : copiez ce fichier en "config.local.js" et renseignez votre propre
// clé API PRIM (gratuite sur https://prim.iledefrance-mobilites.fr). Ne committez jamais config.local.js.
const CONFIG = {
  apiKey: 'VOTRE_CLE_API_PRIM_ICI',
